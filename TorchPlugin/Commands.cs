...
namespace TorchPlugin
{
    public class Commands : CommandModule
    {
        ...
        {
            Respond("NachoPlayerTracker commands:");
            Respond("  !cmd help");
            Respond("  !cmd info");
        ...
        [Command("cmd help", "NachoPlayerTracker: Help")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd info", "NachoPlayerTracker: Prints the current settings")]
        [Permission(MyPromoteLevel.None)]
        public void Info()
        {
            RespondWithInfo();
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd enable", "NachoPlayerTracker: Enables the plugin")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd disable", "NachoPlayerTracker: Disables the plugin")]
        [Permission(MyPromoteLevel.Admin)]
        public void Disable()
        {
        ...
        // TODO: Subcommand
        // ReSharper disable once UnusedMember.Global
        [Command("cmd subcmd", "NachoPlayerTracker: TODO: Subcommand")]
        [Permission(MyPromoteLevel.Admin)]
